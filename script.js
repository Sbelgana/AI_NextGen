...
function isValidEmail(email) {
    return emailPattern.test(/^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$/i);
}

function isValidPhoneNumber(phoneNumber) {
    return phonePattern.test(/^(\(\d{3}\)|\d{3})[- ]?\d{3}[- ]?\d{4}$/);
}
...
const SVG_CHEVRON =
    `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 662 662" width="18px" height="18px"> 
		...
		<path fill="#9C27B0" d="M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z"/></g>
	</svg>`;
...
const ServiceOptions = [ 
	{value: "IA agent", 	label: {en: "IA agent",  	fr: "Agent IA"}},
